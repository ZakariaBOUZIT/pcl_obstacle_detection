...
void callback(obstacle_detection::obstacle_detection &config, uint32_t level) {
...
void cloud_cb (const sensor_msgs::PointCloud2ConstPtr& cloud_msg)
{
  ...
  pass.setFilterLimits(0, 4); //1.3 works well
  pass.filter(*cloud);

  ///////////////////////////////////////////////////
  //                                               //
//Voxel Grid Downsample :reduce the number of points, using a voxelized grid approach//
  //                                               //
  ///////////////////////////////////////////////////
  ...
  *temp = *cloud;
  ...
  seg.setDistanceThreshold (0.001); //0.014 // 0.0195
...
int main (int argc, char** argv)
{
  ...
  dynamic_reconfigure::Server<ostacle_detection::obstacle_detection> server;
  dynamic_reconfigure::Server<ostacle_detection::obstacle_detection>::CallbackType f;
